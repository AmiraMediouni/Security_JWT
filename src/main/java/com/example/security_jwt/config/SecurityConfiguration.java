...
import static com.example.security_jwt.user.Permission.*;
import static com.example.security_jwt.user.Role.ADMIN;
import static com.example.security_jwt.user.Role.MANAGER;
